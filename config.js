...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~8c6ee7wcpe6869f3fa50a0eb3288271b31f6', //your ssid to run bot
    HEROKU: {
    ...
    BOT_INFO : process.env.BOT_INFO || "ZzZ;"INRLhttps://telegra.ph/file/a53ab5760d07005b85008.jpg",
    WORKTYPE : process.env.WORKTYPE || "public",
    PREFIX : process.env.PREFIX || "[false]",//both  .  and [.] equal, for multi prefix we use [] this
    LANG : process.env.LANG || "en",
    PERSONAL_MESSAGE: process.env.PERSONAL_MESSAGE || "null",
    BOT_PRESENCE : process.env.BOT_PRESENCE || "unavailable",
    AUDIO_DATA : process.env.AUDIO_DATA || "ZzZ;INRLhttps://telegra.ph/file/a53ab5760d07005b85008.jpg",
    STICKER_DATA : process.env.STICKER_DATA || "𝒁𝑼𝑬𝑺 𝑯4𝑿𝒁 !",
